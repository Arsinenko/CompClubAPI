        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    revenue = table.Column<bool>(type: "bit", nullable: true),
                    description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    created_at = table.Column<DateTime>(type: "datetime", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__CostReve__3213E83F693444FD", x => x.id);
                    table.ForeignKey(
                        name: "FK__CostReven__id_cl__55009F39",
                        column: x => x.id_club,
                        principalTable: "Club",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    finances = table.Column<decimal>(type: "money", nullable: false),
                    client_number = table.Column<int>(type: "int", nullable: true),
                    id_club = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Statisti__3213E83F70667EBB", x => x.id);
                    table.ForeignKey(
                        name: "FK__Statistic__id_cl__57DD0BE4",
                        column: x => x.id_club,
                        principalTable: "Club",
                        principalColumn: "id");
                });
