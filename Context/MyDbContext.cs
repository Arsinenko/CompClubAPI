...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BalanceHistory>(entity =>
        {
            ...
            entity.HasIndex(e => e.AccountId, "IX_BalanceHistory_account_id");
        ...
        modelBuilder.Entity<Booking>(entity =>
        {
            ...
            entity.HasIndex(e => e.AccountId, "IX_Booking_account_id");

            entity.HasIndex(e => e.IdPaymentMethod, "IX_Booking_id_payment_method");

            entity.HasIndex(e => e.IdStatus, "IX_Booking_id_status");
        ...
        modelBuilder.Entity<CostRevenue>(entity =>
        {
            ...
            entity.HasIndex(e => e.IdClub, "IX_CostRevenue_id_club");
        ...
        modelBuilder.Entity<Feedback>(entity =>
        {
            ...
            entity.HasIndex(e => e.AccountId, "IX_Feedback_account_id");
        ...
        modelBuilder.Entity<Payment>(entity =>
        {
            ...
            entity.HasIndex(e => e.AccountId, "IX_Payment_account_id");
        ...
        modelBuilder.Entity<Statistic>(entity =>
        {
            ...
            entity.HasIndex(e => e.IdClub, "IX_Statistic_id_club");
            ...
            entity.HasOne(d => d.IdClubNavigation).WithMany(p => p.Statistics).HasForeignKey(d => d.IdClub);
        });
        ...
        modelBuilder.Entity<WorkingSpace>(entity =>
        {
            ...
            entity.HasIndex(e => e.TariffId, "IX_WorkingSpace_tariff_id");
